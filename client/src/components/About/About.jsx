...
const About = () => {
  // Animation refs for first section
  const firstImageRef = useScrollAnimation('fadeLeft', { duration: 1.2 });
  const firstTitleRef = useScrollAnimation('fadeUp', { delay: 0.2 });
  const firstTextRef = useScrollAnimation('fadeUp', { delay: 0.4 });

  // Animation refs for second section
  const secondTitleRef = useScrollAnimation('fadeUp', { delay: 0.2 });
  const secondTextRef = useScrollAnimation('fadeUp', { delay: 0.4 });
  const secondImageRef = useScrollAnimation('fadeRight', { duration: 1.2 });
      ...
      <div className={styles.container}>
        <div className={styles.flexRow}>
          ...
          <div className={styles.textWrapper}>
            <h2 ref={firstTitleRef} className={styles.title}>Rest Easy, Live Naturally</h2>
        ...
        <div className={styles.flexRow}>
            ...
            <h2 ref={secondTitleRef} className={styles.title}>Serenity Waits for You</h2>
          ...
          <div className={styles.imageWrapper}>
            <div ref={secondImageRef} className={styles.layeredImages}>
              <img
                src="/sides/2.jpeg"
                alt="Kerala side view at The Perch"
